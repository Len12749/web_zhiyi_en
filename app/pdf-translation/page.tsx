...
import { Upload, FileText, CheckCircle, AlertCircle, Languages, Download, Settings, Loader2 } from 'lucide-react';
...
export default function PDFTranslationPage() {
  ...
  const handleStartTranslation = async () => {
    ...
    try {
      ...
      // TODO: 集成PDF页数检测
      const pageCount = uploadResult.additionalInfo?.pageCount || 1;

      if (pageCount > MAX_PAGES) {
        throw new Error(`PDF页数超出限制。最多支持 ${MAX_PAGES} 页，当前文件有 ${pageCount} 页。`);
      }
